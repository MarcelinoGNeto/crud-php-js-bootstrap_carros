...
<form action="?page=modelo-salvar" method="POST">
    ...
    <div class="mb-3">
        <label>Modelo</label>
        <input type="text" name="nome_modelo" class="form-control" value="<?php print $row_1->nome_modelo; ?>">
    </div>
    <div class="mb-3">
        <label>Cor</label>
        <input type="text" name="cor_modelo" class="form-control" value="<?php print $row_1->cor_modelo; ?>">
    </div>
    <div class="mb-3">
        <label>Ano</label>
        <input type="text" name="ano_modelo" class="form-control" value="<?php print $row_1->ano_modelo; ?>">
    </div>
    <div class="mb-3">
        <label>Placa</label>
        <input type="text" name="placa_modelo" class="form-control" value="<?php print $row_1->placa_modelo; ?>">
    </div>
    <div class="mb-3">
